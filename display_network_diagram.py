...
class GraphApp:
    ...
    def draw_edges(self):
        for edge in self.edges:
            ...
            label_x = (x1 + x2) / 2 + (-dy) * 0.02
            label_y = (y1 + y2) / 2 + dx * 0.02
...
def main():
    ...
    connections3 = [(0, 0, 1, 9, 0.18), (0, 7, 1, 2, 0.54), (1, 10, 1, 0, -0.01), (0, 2, 1, 9, 0.52), (0, 1, 1, 8, 0.56), (0, 4, 1, 5, -0.54), (1, 6, 1, 2, -0.7), (0, 2, 1, 11, -0.19), (0, 7, 1, 11, 0.94), (0, 5, 1, 8, 0.5), (1, 1, 1, 7, 0.73), (1, 12, 1, 13, -0.42), (1, 3, 1, 4, -0.27), (0, 3, 1, 12, -0.28), (0, 2, 1, 4, 0.72), (0, 5, 1, 1, 0.23), (1, 6, 1, 10, 0.99), (0, 2, 1, 6, 0.38), (1, 8, 1, 3, -0.39),(1, 1, 2, 2, 0.49), (1, 7, 2, 0, 0.55), (0, 3, 2, 4, 0.46), (0, 1, 2, 2, -0.13), (0, 7, 2, 5, 0.59), (0, 5, 2, 2, 0.64), (0, 1, 2, 6, -0.32), (1, 10, 2, 1, -0.5), (1, 7, 2, 5, 0.34), (1, 1, 2, 6, -0.35), (1, 12, 2, 3, -0.79), (0, 5, 2, 2, 0.78), (0, 7, 2, 0, -0.62), (0, 1, 2, 5, -0.13), (0, 7, 2, 4, 0.27), (1, 3, 2, 6, -0.07), (0, 3, 2, 7, 0.96), (0, 2, 2, 4, 0.51), (0, 5, 2, 7, -0.95)]
